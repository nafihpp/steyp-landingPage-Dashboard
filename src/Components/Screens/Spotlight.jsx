        ...
        <MainSection>
            <Wrapper>
                <MainDiv>
                    <DivLeft>
                        <Headline>
                            Creating <br /> Computer{" "}
                            <Greenspan>Engineers</Greenspan>
                    ...
                    <DivRight>
                        <DivSite>
                            <SiteImg
                                src={require("../../assets/spotlight-background.png")}
                            />
                        </DivSite>
                        <DivMammo>
                            <MommoImg
                                src={require("../../assets/spotlight-mammookka.png")}
                            />
                        </DivMammo>
                    </DivRight>
                </MainDiv>
